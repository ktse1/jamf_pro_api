...
The sources for jamf Pro API can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/sreyemnayr/jamf_pro_api
.. _tarball: https://github.com/sreyemnayr/jamf_pro_api/tarball/master
